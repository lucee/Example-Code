component {
	...
	*/
	public function findLast(required string needle, required string haystack) {
	    local.index=find(reverse(needle),reverse(haystack));
	    if(index==0) return 0;
	...
	* @return This method returns 0 if the index is not found.
	*/
	public function findLastNoCase(required string needle, required string haystack) {
